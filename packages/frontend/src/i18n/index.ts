...
const translations: Translations = {
  ...
  'admin.apiKeyRevoked': { 'zh-CN': '已撤销', 'en-US': 'Revoked' },
  'admin.apiKeyRevoke': { 'zh-CN': '撤销', 'en-US': 'Revoke' },
  'admin.apiKeyRevokeConfirm': { 'zh-CN': '确定要撤销此 API 密钥？此操作不可恢复。', 'en-US': 'Revoke this API key? This cannot be undone.' },
