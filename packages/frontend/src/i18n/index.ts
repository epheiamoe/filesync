...
const translations: Translations = {
  ...
  'rooms.onlineMembers': { 'zh-CN': '在线成员', 'en-US': 'Online Members' },
  'rooms.noMembersOnline': { 'zh-CN': '暂无在线成员', 'en-US': 'No members online' },
  'rooms.you': { 'zh-CN': '（你）', 'en-US': '(you)' },
  ...
  'rooms.scanCameraBusy': { 'zh-CN': '摄像头正被其他应用占用，请关闭后重试。', 'en-US': 'Camera is in use by another app. Close it and try again.' },
  'rooms.scanNoCamera': { 'zh-CN': '未检测到摄像头设备。请使用"上传图片识别"功能。', 'en-US': 'No camera detected. Please use "Upload Image" instead.' },
  'rooms.scanCameraBlocked': { 'zh-CN': '摄像头权限已被浏览器屏蔽。请在浏览器设置中允许此站点访问摄像头，或使用"上传图片识别"。', 'en-US': 'Camera access is blocked in browser settings. Please allow camera for this site, or use "Upload Image".' },
  ...
  'transfer.destroy10sec': { 'zh-CN': '10 秒', 'en-US': '10 sec' },
  'transfer.destroy30sec': { 'zh-CN': '30 秒', 'en-US': '30 sec' },
  'transfer.destroy1min': { 'zh-CN': '1 分钟', 'en-US': '1 min' },
  'transfer.destroy5min': { 'zh-CN': '5 分钟', 'en-US': '5 min' },
  ...
  'transfer.timeRemainingTooltip': { 'zh-CN': '{time}', 'en-US': '{time}' },
  ...
  'admin.apiKeys': { 'zh-CN': 'API 密钥管理', 'en-US': 'API Key Management' },
  'admin.apiKeyLabel': { 'zh-CN': '标签', 'en-US': 'Label' },
  'admin.apiKeyLabelPlaceholder': { 'zh-CN': '例如：CI 部署', 'en-US': 'e.g., CI deploy' },
  'admin.createApiKey': { 'zh-CN': '创建 API 密钥', 'en-US': 'Create API Key' },
  'admin.apiKeyCreated': { 'zh-CN': 'API 密钥已创建，请立即复制', 'en-US': 'API key created. Copy it now.' },
  'admin.apiKeyPrefix': { 'zh-CN': '前缀', 'en-US': 'Prefix' },
  'admin.apiKeyStatus': { 'zh-CN': '状态', 'en-US': 'Status' },
  'admin.apiKeyActive': { 'zh-CN': '有效', 'en-US': 'Active' },
  'admin.apiKeyDelete': { 'zh-CN': '删除', 'en-US': 'Delete' },
  'admin.apiKeyDeleteTitle': { 'zh-CN': '删除 API 密钥', 'en-US': 'Delete API Key' },
  'admin.apiKeyDeleteDescription': { 'zh-CN': '你即将永久删除标签为 "{label}"、前缀为 "{prefix}" 的 API 密钥。删除后该密钥立即失效，无法恢复。', 'en-US': 'You are about to permanently delete the API key labeled "{label}" with prefix "{prefix}". It will be invalidated immediately and cannot be recovered.' },
  'admin.apiKeyDeleteConfirm': { 'zh-CN': '请输入该密钥的前缀以确认删除。', 'en-US': 'Please type the prefix of this key to confirm deletion.' },
  'admin.apiKeyDeletePrefixHint': { 'zh-CN': '请输入上方显示的前缀', 'en-US': 'Enter the prefix shown above' },
  'admin.apiKeyDeletePrefixPlaceholder': { 'zh-CN': '输入前缀', 'en-US': 'Type prefix' },
  'admin.apiKeyDeletePrefixMismatch': { 'zh-CN': '输入与前缀不匹配', 'en-US': 'Prefix does not match' },
  'admin.apiKeyDeletePrefixCopy': { 'zh-CN': '复制前缀', 'en-US': 'Copy prefix' },
  'admin.apiKeyDeletePrefixCopied': { 'zh-CN': '已复制', 'en-US': 'Copied' },
  'admin.apiKeyCopy': { 'zh-CN': '复制 API 密钥', 'en-US': 'Copy API key' },
  'admin.apiKeyCopied': { 'zh-CN': '已复制', 'en-US': 'Copied' },
  'admin.apiKeyEmpty': { 'zh-CN': '暂无 API 密钥', 'en-US': 'No API keys' },
